...
var serno_re=/(?:(?:SG-[0-9A-Z]{4}(?:RPi[123z]|BBBK|BB[0-9][0-9A-Z])[0-9A-Z]{4}(?:_[0-9])?)|(?:Lotek-D?[0-9]+(?:_[0-9])?)|(?:CTT-(?:[0-9]{15}|[0-9A-F]{12}))|(?:SEI-[0-9A-Z]{10}))|(?:-[0-9A-Z]{4}(?:RPi[123z]|BBBK|(?:BB[0-9][0-9A-Z]))[0-9A-Z]{4}-)/ig;
...
function show_job_list() {
    ...
    if (state.selector.motusUserID) {
        ...
        if (! serno.match(/^(Lotek-|SG-|CTT-|SEI-)/i)) {
            serno = "SG-" + serno;
        }
