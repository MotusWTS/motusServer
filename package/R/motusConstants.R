...
MOTUS_API_REGISTER_RECEIVER = 'http://motus-wts.org/data/api/v1.0/registersensor.jsp'
...
MOTUS_API_LIST_SENSOR_DEPS = 'http://motus-wts.org/data/api/v1.0/listsensordeployments.jsp'
