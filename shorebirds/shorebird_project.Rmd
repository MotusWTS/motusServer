...
Most of the tags listed in the spreadsheet could be linked to tags
registered with motus-wts.org, or at least with sensorgnome.org.  The
remaining tags are discussed along the way, and labelled __[Sjoerd]__
to indicate he may be able to resolve the problems.
...
There are no detections of tag 204 at Grande-Île or any of the nearby
...
saveRDS(list(found=found, lost=lost, multi=multi, collide=collide), RESULTS_FILE)
```
