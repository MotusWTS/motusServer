...
```
Now, get additional registration from project "Coates":

```{r}
motus = motus %>% bind_rows(getProjectTags(66))
```
...
`r lost %>% filter(name="Paul Smith") %>% as.data.frame`

Perhaps it is either 454 or 445, both registered to motus project
66 (EBM Coats), and not matched to any other tags in the spreadsheet.
**[Sjoerd]**


### Rebecca Holberton / Lindsay Tudor 2015, 2014 Tags
