#' Merge a batch of Lotek .DTA files with the old-style sensorgnome
#' YEAR/PROJECT/SITE hierarchy, updating any sites affected.
#'
...
ltMergeFilesOldWay = function(files) {
    ...
    rv = data_frame(fullname = ff, nameNew = TRUE, dataNew = TRUE, use = FALSE, err = NA)
