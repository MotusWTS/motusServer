...
## old: MOTUS_API_REGISTER_RECEIVER     = "https://motus.org/data/api/v1.0/registersensor.jsp"
## uncomment this one once changes from the beta server have been made live:
## MOTUS_API_REGISTER_RECEIVER     = "https://motus.org/api/receiver/register"
MOTUS_API_REGISTER_RECEIVER     = "https://beta.motus.org/api/receiver/register"
