...
MOTUS_PATH = list(
    ...
    PRIORITY         = "/sgm/priority/",             ## folders or files moved here run on a processServer dedicated to short, fast jobs; e.g. updating attached SGs
    ...
    QUEUE7           = "/sgm/queue/7/",
    QUEUE8           = "/sgm/queue/8/",
    QUEUEP1          = "/sgm/queue/101/",            ## priority job queues 101..104; for the processServer dedicated to short, fast jobs; e.g. updating attached SGs.
    QUEUEP2          = "/sgm/queue/102/",
    QUEUEP3          = "/sgm/queue/103/",
    QUEUEP4          = "/sgm/queue/104/",
