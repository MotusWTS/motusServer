...
refreshMotusMetaDBCache = function() {
    ...
    tryCatch({
        ...
        recv$receiverType = ifelse(grepl("^SG-", recv$serno, perl=TRUE), "SENSORGNOME", ifelse(grepl("^CTT-", recv$serno, perl=TRUE), "SENSORSTATION", ifelse(grepl("^SEI-", recv$serno, perl=TRUE), "SIGMA8", "LOTEK")))
